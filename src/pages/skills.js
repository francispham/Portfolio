...
const Skills = () => {
  const data = useStaticQuery(graphql`
    query {
      ...
      svelte: file(relativePath: { eq: "icon/svelte.png" }) {
        childImageSharp {
          fixed(width: 80, height: 80) {
            ...GatsbyImageSharpFixed
          }
      ...
      heroku: file(relativePath: { eq: "icon/heroku.png" }) {
        childImageSharp {
          fixed(width: 80, height: 80) {
            ...GatsbyImageSharpFixed
          }
      ...
      apollo: file(relativePath: { eq: "icon/apollo.png" }) {
        childImageSharp {
          fixed(width: 80, height: 80) {
            ...GatsbyImageSharpFixed
          }
  ...
  return (
    <Layout >
      ...
      <div>
        <div className="box">
          <div className='skill-container' style={{ justifyContent: 'space-around' }}>
            {Object.entries(data).map((key, index) => <div key={index}><Img fixed={key[1].childImageSharp.fixed}/></div>)}
          </div>
          <br />
        </div>
      </div>
