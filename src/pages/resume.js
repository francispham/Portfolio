      ...
      <section className="main">
        <div>
          ...
          <ul>
            ...
            <li>
              FRONTEND: ReactJS, Redux, HTML5, CSS3/SASS, jQuery, Bootstrap4...{' '}
            </li>
            <li>BACKEND: NodeJS, ExpressJS, Ruby on Rails, RESTful, APIs...</li>
            <li>DATABASES: PostgreSQL, MongoDB, AWS, FireBase...</li>
            <li>
              DEVELOPMENT & DEV TOOLS: Git/GitHub or BitBucket,Webpack, Heroku,
              Netlify, AWS S3...
            </li>
            <li>
        ...
        <div className="work">
          ...
          <ul>
            <li>
              AssistList 2019: Web Application Volunteer. Key Responsibilities - Weekly meetup with other
              team members, fixed bugs & contributed to the website code base.
              Stack:{' '}
              <em>
            ...
            <li>
              Drill Ninjaz 2018: Key Responsibilities - Collaborated with other
              team members, Designed, developed, tested some of the app's
              features. The team won second place for this group project. Built
              with <em>Ruby on Rails & PostgreSQL</em>.
              <p>
                <a
